...
This data contains information and statistics from the trash collectors
in Baltimore, Maryland. It include the number of different type of trash
at a given time. In this datasets, the dimension is 1868\*19. The file
was imported with specified variable type assigned with function
